      ...
      <input type="hidden" id="hd_documentIdModulo___${indexModulo}">
        <div class='row' id="alvo1___${indexModulo}">
            <div class='col-md-2'>
              ...
              <input type='text' class='form-control' id='idModulo___${indexModulo}' name='idModulo___${indexModulo}'>
            </div>
            <div class='col-md-10'>
                ...
                <div onclick="limpar1(this)" style="position: absolute; right: 25px; top: 50%; background-color: transparent;"><img src="/cadastro_curso_mfx_academy/resources/images/trash.png" alt="Cadastro" class="panel-icon"></div>
            </div>
        </div>
      </div>
    `
            ...
            <div class="card-body" style="position: relative; border-radius: 10px; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                ...
                <div class='row'>
                    ...
                    <div class='col-md-1'>
									...
									<input type='text' class='form-control' id='idTurma___${indexTurma}' name='idTurma___${indexTurma}' />
								</div>
                </div>
      ...
      <input type="hidden" id="hd_documentIdPagamento___${indexPagamento}">
        <div class='row' id="alvo2___${indexPagamento}">
            <div class="col-md-2">
              ...
              <input type='text' class='form-control' id='idPagamento___${indexPagamento}' name='idPagamento___${indexPagamento}'>
            </div>
            <div class='col-md-10'>
              <label for='formaPagamento'>Forma de Pagamento</label>
              <input type='text' class='form-control' id='formaPagamento___${indexPagamento}' name='formaPagamento___${indexPagamento}'>
                <div onclick="limparPagamento(this)" style="position: absolute; right: 25px; top: 50%; background-color: transparent;"><img src="/cadastro_curso_mfx_academy/resources/images/trash.png" alt="Cadastro" class="panel-icon"></div>
            </div>
        </div>
      </div>
    `
...
function limparPagamento(lixeira2) {
  MyWidget.modulosRemovidos.push($(lixeira2.parentElement.parentElement.parentElement).find("[id*=hd_documentIdPagamento___]").val())
               ...
               <a class="collapse-icon" data-toggle="collapse" data-parent="#accordion___${count}" href="#collapseOne___${count}">
                  <div class='row'>
                        ...
                        <div class='col-md-2'>
                          ...
                          <div class="card-header-info">R$ ${registro.valorCurso}</div>
                        </div>
                        <div class='col-md-2'>
...
$(document).ready(function () {
  $("#parcelas").on("change", (e) => {
    ...
    $("#valorMensal").val((valorCurso / parcelas).toFixed(2));
  });

  $("#valorCurso").on("change", (e) => {
    var valorCurso = parseFloat($("#valorCurso").val());
    var parcelas = parseInt($("#parcelas").val());
